...
<html>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class ="container">
                <br><div class ="title">Add Merchandise</div><br><br>
                <form action = "merchandise_processing.jsp">
                    ...
                    <div class ="input-user">
                        ...
                        <div class="input-details">
                            <span class="details">Item Name</span>
                                <input type = "text" id = "item_name" name = "item_name" placeholder="Enter the item name" required><br>
                        </div><br>
                        <div class="input-details">
                            <span class="details">Price</span>
                            <input type = "number" step="any" id = "price" name = "price" placeholder="Enter the price ($)" required><br>
                        </div><br>           
                        <div class="input-details">
                            <span class="details">Quantity</span>
                                <input type = "number" id = "quantity_in_stock" name = "quantity_in_stock" placeholder="Enter the quantity" required><br>
                        </div><br>
                        <div class ="button">
                                 ...
                                 <%
                                    ...
                                    if(error != null) 
                                    {
                                        if("1".equals(error)) { %>
                                            ...
                                            <span class = "err"> There is already an item with this name. </span> <% 
                                        } 
                                    }
                                    ...
                                    {
                                        %> <span class = "success"> Item successfully added! </span> <%
                                    }
