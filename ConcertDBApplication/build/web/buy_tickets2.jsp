...
<html>
    ...
    <body>
        ...
        <%
            ...
            T.available_ticket_type_list(concert_ID);
            if(T.get_ticket_type_ID_list().size() == 0)
            {
        ...
        <div class="container-wrapper">
            <div class="container">
                ...
                <form action = "ticket_transaction_processing.jsp" method = "GET">
                    ...
                    <div class="input-user">
                        ...
                        <div class="input-details">
                            <%
                                    ...
                                    for(int i = 0; i < T.get_ticket_type_ID_list().size(); i++)
                                    {%>
                                        <span class="details"><%=T.get_type_name_list().get(i)+ " (Stock: " + T.get_quantity_in_stock_list().get(i) + ") - " + T.get_price_list().get(i) + "$"%></span>
                                        <input type = "number" id = "<%=i%>" min = "0" name = "<%=i%>" placeholder="Enter the number of tickets to buy" required><br><br>
                                    <%
                                        }
                                %>
                        </div>
                        ...
                        <%
                                    ...
                                    if(success != null)
                                    {
                                        %> <span class = "success"> Tickets successfully bought for <%=Double.parseDouble(success)%>$! </span> <%
                                    }
                                %>
                    </div>
                </form>
