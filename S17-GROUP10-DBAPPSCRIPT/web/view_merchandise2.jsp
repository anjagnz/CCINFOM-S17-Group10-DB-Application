...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                response.sendRedirect("view_merchandise.jsp?error=2");
            }
            else
            {
                ...
                {
                    response.sendRedirect("view_merchandise.jsp?error=1");
                }
            }
        %>
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">View Merchandise</div><br><br>
            </div>
                    <%
                        for(int i = 0; i < M.get_item_ID_list().size(); i++)
                        {%>
                            <div class="container">
                                <br><div class="subtitle"><%=M.get_item_name_list().get(i)%></div><br><br>
                                <span class="subdetails"><b>Item ID: </b> <%=M.get_item_ID_list().get(i)%></span><br>
                                <span class="subdetails"><b>Price: </b> <%=M.get_price_list().get(i)%>$</span><br>
                                <span class="subdetails"><b>Quantity in Stock: </b> <%=M.get_quantity_in_stock_list().get(i)%></span><br>
                                <span class="subdetails"><b>Concert ID:</b> <%=M.get_concert_ID_list().get(i) + " (" + M.find_concert(concert_ID) + ")"%></span><br>
                            </div><%
                        }
                        %>
            </div><br>
