...
<html>
    <head>
        ...
        <title>Venue Merchandise Sales Report</title>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Venue Merchandise Sales Report</div><br><br>
                <form action = "cut_sales_report.jsp" method = "GET">
                    ...
                    while(!curr_date.after(month_end))
                    {
                         %>
                            <div class="container">
                                ...
                                <%
                                sold = V.merchandise_sold_in_venue(venue_ID, curr_date);
                                total = V.cut_earned(venue_ID, curr_date);
                                %>
                                <span class="subdetails"><b>Merchandise Sold: </b><%=sold%></span><br>
                                <span class="subdetails"><b>Money Earned: </b><%=total%>$</span><br>
                                
                            </div>
                            <%
                        curr_date = new Date(curr_date.getTime() + 24 * 60 * 60 * 1000);
                        all_days_sold += sold;
                        all_days_value += total;
                    }%>
                    <div class="container">
