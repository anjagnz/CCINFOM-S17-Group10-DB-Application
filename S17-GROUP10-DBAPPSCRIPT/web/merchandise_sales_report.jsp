...
<html>
    <head>
        ...
        <title>Concert Merchandise Sales Report</title>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Concert Merchandise Sales Report</div><br><br>
                <form action = "merchandise_sales_report.jsp" method = "GET">
            ...
            <%
                ...
                if(selected_concert != null && selected_yearmonth != null)
                {
                    ...
                    while(!curr_date.after(month_end))
                    {
                         %>
                            <div class="container">
                                ...
                                <span class="subdetails"><b>Merchandise Sold:</b></span><br>
                                <%
                                ...
                                %>
                                    <span class="subdetails"><b><%=M.get_item_name_list().get(i)%>: </b><%=sold + " (" + total +"$)"%></span><br>
                                <%  total_sold += sold;
                                    total_value += total;
                                    }%>
                    ...
                    <div class="container">
                        <br><div class="subtitle">Total Merchandise Sales For <%=selected_yearmonth%>:</div><br><br>
                        <span class="subdetails"><b>Total Merchandise Sold: </b><%=all_days_sold%></span><br>
