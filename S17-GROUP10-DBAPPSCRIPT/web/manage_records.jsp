    ...
    <body>
        ...
        <div class ="container">
            ...
            <div class="ticket-button-container">
                <button class="button" onclick="window.location.href='add_tickets.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-plus" style="color: #000000;"></i><i class="fa-solid fa-ticket" style="color: #000000;"></i></span><br>
                    <span class="button-title">Add Tickets</span><br>
                </button>
                <button class="button" onclick="window.location.href='view_tickets.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-magnifying-glass" style="color: #000000;"></i><i class="fa-solid fa-ticket" style="color: #000000;"></i></span><br>
                    <span class="button-title">View Tickets</span><br>
                </button>
            </div><br><br>
            <div class="venue-button-container">
                <button class="button" onclick="window.location.href='add_venues.jsp'">
                    ...
                    <span class="button-title">Add Venues</span><br>
                </button>
                <button class="button" onclick="window.location.href='view_venues.jsp'">
                    ...
                    <span class="button-title">View Venues</span><br>
                </button>
            </div><br><br>
            <div class="merchandise-button-container">
                <button class="button" onclick="window.location.href='add_merchandise.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-plus" style="color: #000000;"></i><i class="fa-solid fa-shirt" style="color: #000000;"></i></span><br>
                    <span class="button-title">Add Merchandise</span><br>
                </button>
                <button class="button" onclick="window.location.href='view_merchandise.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-magnifying-glass" style="color: #000000;"></i><i class="fa-solid fa-shirt" style="color: #000000;"></i></span><br>
                    <span class="button-title">View Merchandise</span><br>
                </button>
            </div><br>
        </div>
    </body>
