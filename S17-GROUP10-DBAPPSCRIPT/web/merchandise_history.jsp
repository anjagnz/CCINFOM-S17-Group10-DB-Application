...
<%@page import = "merchandise_purchase_management.*"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Merchandise Purchase History</title>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Merchandise Bought</div><br><br>
            </div>
                    ...
                    if(curr_session != null && curr_session.getAttribute("user_id") != null)
                    {
                        ...
                        Mp.customer_purchase_list(1);
                        System.out.println(Mp.get_merchandise_purchase_ID_list().size());
                        for(int i = 0; i < Mp.get_merchandise_purchase_ID_list().size(); i++)
                        {%>
                            <div class="container">
                                
                                <br><div class="subtitle"><%=Mp.find_item_name(Mp.get_merchandise_purchase_ID_list().get(i))%></div><br><br>
                                <span class="subdetails"><b>From Concert:</b> <%=Mp.find_concert_from_merchandise(Mp.get_merchandise_purchase_ID_list().get(i))%></span><br>
                                <span class="subdetails"><b>Buyer: </b> <%=Mp.find_customer_name(Mp.get_transaction_ID_list().get(i))%></span><br>
                                <span class="subdetails"><b>Quantity Bought: </b> <%=Mp.get_quantity_bought_list().get(i)%></span><br>
                                <span class="subdetails"><b>Time of Purchase:</b> <%=Mp.find_purchase_time(Mp.get_transaction_ID_list().get(i))%></span><br>
                                <span class="subdetails"><b>Total:</b> <%=Mp.purchase_total(Mp.get_merchandise_purchase_ID_list().get(i))%></span><br>
                            </div>
                        <%}
}%>
                    </div>
