...
<html>
    <head>
        ...
        <title>Venue Rental Sales Report</title>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Venue Rental Sales Report</div><br><br>
                <form action = "rental_sales_report.jsp" method = "GET">
            ...
            <%
                ...
                if(selected_venue != null && selected_yearmonth != null)
                {
                    ...
                    while(!curr_date.after(month_end))
                    {
                         %>
                            <div class="container">
                                ...
                                <%
                                sold = V.times_rented(venue_ID, curr_date);
                                total = sold * V.get_rental_fee_list().get(venue_ID-1);
                                %>
                                <span class="subdetails"><b>Times Rented: </b><%=sold%></span><br>
                    ...
                    <div class="container">
                        <br><div class="subtitle">Total Rental Sales For <%=selected_yearmonth%>:</div><br><br>
                        <span class="subdetails"><b>Total Times Rented: </b><%=all_days_sold%></span><br>
