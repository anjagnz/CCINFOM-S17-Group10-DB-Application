...
public class Merchandise {
    ...
    public int merchandise_list(int passed_concert_ID) throws ClassNotFoundException
    {
        try
        {
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT item_ID, item_name, price, quantity_in_stock, concert_ID FROM Merchandise WHERE concert_ID = ?");
    ...
    public String find_concert(int concert_ID) throws ClassNotFoundException
    {
        String name = "";
        ...
        {   
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT concert_name FROM Concerts WHERE concert_ID = ?");
