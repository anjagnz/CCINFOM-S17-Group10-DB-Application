    ...
    <body>
        ...
        <div class ="container">
            <br><br><br><div class="concert-button-container">
                ...
                <button class="button" onclick="window.location.href='merchandise_sales_report.jsp'">
                ...
                <button class="button" onclick="window.location.href='concert_sales_report.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-magnifying-glass" style="color: #000000;"></i><i class="fa-solid fa-music" style="color: #000000;"></i></span><br>
                    <span class="button-title">Concert Total Sales Report</span><br>
                </button>
            </div><br><br>
            <div class="venue-button-container">
                <button class="button" onclick="window.location.href='rental_sales_report.jsp'">
                ...
                <button class="button" onclick="window.location.href='cut_sales_report.jsp'">
                ...
                <button class="button" onclick="window.location.href='venue_sales_report.jsp'">
                    <br><span class="icon"><i class="fa-solid fa-magnifying-glass" style="color: #000000;"></i><i class="fa-solid fa-building" style="color: #000000;"></i></span><br>
