...
<html>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Buy Merchandise</div><br><br>
                <form action = "buy_merchandise2.jsp" method = "GET">
                    ...
                    <div class="input-user">
                        ...
                        <%
                                    ...
                                    {
                                        if("1".equals(error)) { %>
                                            <span class = "err"> This concert is not currently selling merchandise. </span> <% 
                                        } else if("2".equals(error)) { %>
                                            <span class = "err"> There are currently no upcoming concerts. </span> <% 
                                    }
                                    }
                                %>
                    </div>
