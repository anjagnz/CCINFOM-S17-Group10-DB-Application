...
<html>
    <head>
        ...
        <title>Concert Total Sales Report</title>
    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container">
                <br><div class ="title">Concert Total Sales Report</div><br><br>
                <form action = "concert_sales_report.jsp" method = "GET">
            ...
            <%
                ...
                if(selected_concert != null && selected_yearmonth != null)
                {
                    ...
                    Double all_days_value_tickets = 0.0, all_days_value_merchandise = 0.0;
                    int all_days_sold_tickets = 0, all_days_sold_merchandise = 0;
                    %>
                    <div class="container">
                    ...
                    while(!curr_date.after(month_end))
                    {
                        ...
                        all_days_sold_tickets += total_sold;
                        all_days_value_tickets += total_value;
                        total_sold = 0;
                        total_value = 0.0;
                        
                        for(int i = 0; i < M.get_item_ID_list().size(); i++)
                        {   sold = C.merchandise_sold(M.get_item_ID_list().get(i), curr_date);
                            total = sold * M.get_price_list().get(i) * ((100-C.find_merchandise_cut(C.get_venue_ID_list().get(concert_ID-1)))/100.0);

                            total_sold += sold;
                            total_value += total;
                        }
                        all_days_sold_merchandise += total_sold;
                        all_days_value_merchandise += total_value;
                        total_sold = 0;
                        total_value = 0.0;
                        curr_date = new Date(curr_date.getTime() + 24 * 60 * 60 * 1000);
                    }%>
                    <div class="container">
                        <br><div class="subtitle">Total Concert Sales For <%=selected_yearmonth%>:</div><br><br>
                        <span class="subdetails"><b>Total Tickets Sold: </b><%=all_days_sold_tickets%></span>
                        <span class="subdetails"><b>Money Earned: </b><%=all_days_value_tickets%>$</span><br>
                        <span class="subdetails"><b>Total Merchandise Sold: </b><%=all_days_sold_merchandise%></span>
                        <span class="subdetails"><b>Money Earned: </b><%=all_days_value_merchandise%>$</span><br>
                        <span class="subdetails"><b>Total Money Earned: </b><%=all_days_value_tickets+all_days_value_merchandise%>$</span><br>
                    </div><%
                }
