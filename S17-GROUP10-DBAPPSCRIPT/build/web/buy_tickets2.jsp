...
<html>
    ...
    <body>
        ...
        <%
            ...
            {
                response.sendRedirect("buy_tickets.jsp?error=2");
            }
            else
            {
                ...
                {
                    response.sendRedirect("buy_tickets.jsp?error=1");
                }
            }
        %>
        <nav>
                    ...
                    <div class="input-user">
                        ...
                        <div class="input-details">
                            <%
                                    ...
                                    {%>
                                        <span class="details"><%=TT.get_type_name_list().get(i)+ " (Stock: " + TT.get_quantity_in_stock_list().get(i) + ") - " + TT.get_price_list().get(i) + "$"%></span>
